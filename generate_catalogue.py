...
APPS = [
    {
        ...
        "icon_bg": "linear-gradient(135deg, #2563eb, #3b82f6)",
        "badge_color": "#2563eb",
        "icon_svg": '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.93a2 2 0 0 1-1.66-.9l-.82-1.2A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13c0 1.1.9 2 2 2Z"></path></svg>',
        ...
        "play_store": "https://play.google.com/store/apps/details?id=com.mohan.filemanager",
        "version": "v1.2.0",
        "size": "24 MB"
    },
    {
        ...
        "play_store": "https://play.google.com/store/apps/details?id=com.mohan.qrscanner",
        "version": "v1.1.4",
        "size": "18 MB"
    },
    {
        ...
        "badge_color": "#7c3aed",
        "icon_svg": '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg>',
        ...
        "play_store": "https://play.google.com/store/apps/details?id=com.mohan.musicplayer",
        "version": "v2.0.1",
        "size": "28 MB"
    },
    {
        ...
        "category": "media",
        "category_label": "Media & Audio",
        "icon_bg": "linear-gradient(135deg, #ea580c, #f97316)",
        "badge_color": "#ea580c",
        "icon_svg": '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"></rect><circle cx="9" cy="9" r="2"></circle><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"></path></svg>',
        "summary": "Lightweight, privacy-first photo gallery with album management, EXIF metadata viewer, biometric hidden vault, and built-in pro image editor and collage maker.",
        "features": [
            ...
            {"title": "Clean Offline Operation", "desc": "Zero tracking, zero cloud uploads. Your photos remain 100% on your device."}
        ],
        "play_store": "https://play.google.com/store/apps/details?id=com.mohan.photos",
        "version": "v1.3.2",
        "size": "26 MB"
    },
    {
        ...
        "badge_color": "#0284c7",
        "icon_svg": '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1-0-5H20"></path></svg>',
        ...
        "play_store": "https://play.google.com/store/apps/details?id=com.mohan.ebookreader",
        "version": "v1.2.0",
        "size": "22 MB"
    },
    {
        ...
        "play_store": "https://play.google.com/store/apps/details?id=com.mohan.pdfreader",
        "version": "v1.4.1",
        "size": "21 MB"
    },
    {
        ...
        "badge_color": "#d97706",
        "icon_svg": '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>',
        ...
        "features": [
            ...
            {"title": "Backup & Export", "desc": "Export notes to PDF, TXT, or JSON and create local offline backups."}
        ],
        "play_store": "https://play.google.com/store/apps/details?id=com.mohan.notes",
        "version": "v1.1.0",
        "size": "19 MB"
    },
    {
        ...
        "tagline": "Mobile Spreadsheet Editor with Formula Engine & Charts",
        "category": "productivity",
        "category_label": "Productivity & Docs",
        "icon_bg": "linear-gradient(135deg, #0d9488, #14b8a6)",
        "badge_color": "#0d9488",
        ...
        "play_store": "https://play.google.com/store/apps/details?id=com.mohan.sheets",
        "version": "v1.0.8",
        "size": "25 MB"
    },
    {
        ...
        "badge_color": "#c026d3",
        "icon_svg": '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="15" x="2" y="4.5" rx="2"></rect><polygon points="10 8 16 12 10 16 10 8"></polygon></svg>',
        ...
        "play_store": "https://play.google.com/store/apps/details?id=com.mohan.videoplayer",
        "version": "v1.2.5",
        "size": "30 MB"
    },
    {
        ...
        "badge_color": "#e11d48",
        "icon_svg": '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"></path><path d="M19 10v2a7 7 0 0 1-14 0v-2"></path><line x1="12" y1="19" x2="12" y2="22"></line></svg>',
        ...
        "play_store": "https://play.google.com/store/apps/details?id=com.mohan.voicerecorder",
        "version": "v1.1.2",
        "size": "17 MB"
    },
    {
        ...
        "category": "utility",
        "category_label": "Utilities & Tools",
        "icon_bg": "linear-gradient(135deg, #ca8a04, #eab308)",
        "badge_color": "#ca8a04",
        "icon_svg": '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',
        ...
        "play_store": "https://play.google.com/store/apps/details?id=com.mohan.torchlight",
        "version": "v1.0.5",
        "size": "12 MB"
    }
]
    ...
    for app in APPS:
      ...
      <article class="app-card" data-category="{app['category']}">
        <div class="app-card-header">
          <div class="app-icon" style="background: {app['icon_bg']};">
            {app['icon_svg']}
          </div>
          <div>
        ...
        <div class="app-card-actions">
          <a href="{app['id']}/index.html" class="btn btn-secondary btn-sm" style="flex: 1;">View Details</a>
          <a href="{app['play_store']}" target="_blank" rel="noopener noreferrer" class="btn btn-primary btn-sm" style="flex: 1.2;">
...
<head>
  ...
  <title>Mohan Apps Showcase | Clean, Fast & Privacy-First Mobile Apps</title>
  <meta name="description" content="Explore Mohan's suite of high-performance mobile applications: File Manager, QR Scanner, Music Player, Photos Gallery, eBook Reader, PDF Reader, Notes, Sheets, Video Player, Voice Recorder, and Torch Light.">
  <style>
{get_shared_css()}
...
<body>
  ...
  <main>
    <section class="hero">
      <div class="container">
        <div class="hero-pill">
          <span>✨ Designed for Speed, Simplicity & Privacy</span>
        </div>
        <h1>Modern Native Android Apps</h1>
        <p>A comprehensive ecosystem of productivity, multimedia, and daily utility apps built with zero bloatware and total respect for your personal privacy.</p>
        ...
        <div class="stats-bar">
          ...
          <div class="stat-item">
            ...
            <span class="stat-label">Offline & Private</span>
          </div>
          <div class="stat-item">
...
{apps_cards_html}
  ...
  <footer>
    <div class="container footer-content">
      ...
      <p>© 2026 Mohan Apps. Crafted with dedication for clean and private mobile experiences.</p>
    ...
    <section class="app-hero">
      <div class="container">
        ...
        <div class="hero-layout">
          <div class="app-detail-icon" style="background: {app['icon_bg']};">
            {app['icon_svg']}
          </div>
          <div class="app-detail-header">
            ...
            <div class="app-spec-badges">
              ...
              <span class="spec-badge">Version: {app['version']}</span>
              <span class="spec-badge">Download Size: {app['size']}</span>
              <span class="spec-badge">Platform: Android 7.0+</span>
              <span class="spec-badge">License: Free / Open Source</span>
            </div>
            <div class="hero-actions">
              <a href="{app['play_store']}" target="_blank" rel="noopener noreferrer" class="btn btn-primary">
